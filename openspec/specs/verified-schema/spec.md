...
The system SHALL provide a schema definition at `openspec/schemas/verified/schema.yaml` with 6 artifacts and structural enforcement of knowledge recording and referencing.
